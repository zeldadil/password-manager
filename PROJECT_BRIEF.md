...
- **Branch retention note (2026-09-20):** four branches from this incident's remediation chain — `fix/telegram-token-rotation-t_28951254`, `fix/sec-incident-telegram-token`, `qa/t_0af5aa3e-rotation-verdict`, `qa/t_b51a1ff3-review-r2` — are intentionally kept as-is. They are cited as verification evidence in the closure comments of already-closed Kanban cards `t_9b3bdba0` and `t_b51a1ff3`. Do not delete or rewrite them without checking those cards' closure comments first (one of these branches was already deleted and had to be restored during this review for exactly this reason).
